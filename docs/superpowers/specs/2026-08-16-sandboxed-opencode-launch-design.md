...
| ------------------------ | ----------------------------------------------------- | ---------------------------------- |
| backend unavailable      | disabled row or `-32006`                              | no runtime/session                 |
| opencode missing         | disabled row or `-32007`, reason `opencode-not-found` | no session                         |
| unsupported shell/kernel | `-32007`, no conventional fallback                    | runtime/channel/artifact closed    |
| launcher render/write    | `-32007`                                              | runtime/channel/artifact closed    |
