...
**AD-11 — Per-pane filesystem sandbox: renderer requests, backend authorizes (experimental, [ADR-0035](decisions/0035-native-per-tab-filesystem-sandbox.md), amended by [ADR-0036](decisions/0036-sandbox-writable-allowlist-and-launch-overrides.md), [ADR-0038](decisions/0038-sandbox-two-class-directory-grants.md), [ADR-0039](decisions/0039-sandbox-launches-an-interactive-shell.md), [ADR-0040](decisions/0040-sandbox-denied-access-inbox.md), and [ADR-0041](decisions/0041-explicit-home-grants-project-into-isolated-home.md); ADR-0039 supersedes ADR-0037's fixed-OpenCode launch target).**
...
- Prevents: renderer-authored policy or launch command; stale or unseen global grants; mutable grants on a running pane; restoring a sandbox pane as an ordinary local shell; and a second policy owner beside `internal/sandbox`.
