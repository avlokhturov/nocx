 ...
 *
 * Source: contracts/notes.update.schema.json
...
/**
 * Result of the notes.update JSON-RPC method: the note as it now stands. createdAt is unchanged — an edit is not a new note.
 */
