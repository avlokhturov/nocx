...
| **CapabilityChip**     | `capability-chip.ts` (vanilla-emitted, beside the editor)                          | `ui-capability-chip` + `__label/__caret`                                                                                                                                             | `data-variant`: native \| blocks \| enhanced \| degraded — the capability statement at the pending command (nocx-4t37.2): what is true right now (Native input / Command blocks / Enhanced input), clickable to open the action popover; `disabled` when nothing is offered (an off-policy connection), the reason in `title` …                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
