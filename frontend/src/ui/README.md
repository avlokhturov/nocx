...
| **SecretOffer**        | `secret-offer.ts` (vanilla-emitted, lives beside the editor it floats over)        | `ui-secret-offer` + `__message/__kind/__name`                                                                                                                                        | the non-modal "store this key?" row: appears when a detected key settles in the line, never steals focus, typing continues while it is up; the name field owns Enter/Esc once clicked into; dismiss marks the value declined for the session ("the masked text is served everywhere else — that is the whole policy")                                                                                                                                                                                                                                                                                                                                                                                   |
