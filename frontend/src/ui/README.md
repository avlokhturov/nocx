...
| **Tabs**             | `tabs.tsx`              | `ui-tabs`, `ui-tabs__list`, `ui-tabs__panel`, `ui-tabs__status` | `data-orientation`: vertical \| horizontal; rows are ghost Buttons; optional `data-tone` on `__status`: ok \| warning \| error |
